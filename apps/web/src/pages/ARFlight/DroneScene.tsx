 ...
 */
export function DroneScene({ parts, inputRef, onAltitudeChange }: DroneSceneProps) {
  return (
    <div className="fixed inset-0 z-10 pointer-events-none">
      ...
      >
        ...
        <FlightController parts={parts} inputRef={inputRef} onAltitudeChange={onAltitudeChange} />
      </Canvas>
    </div>
  )
}

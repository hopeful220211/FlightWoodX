        ...
        {isPartsLibraryOpen ? (
          <Card hoverable={false} className="p-3">
            <div className="flex items-center justify-between gap-2">
              ...
              <button
                type="button"
                className="touch-target inline-flex h-8 w-8 items-center justify-center rounded-lg hover:bg-wood-50 dark:hover:bg-slate-900"
                aria-label="收起零件库"
            ...
            <div className="mt-3 flex items-center gap-2 rounded-lg border border-black/10 bg-white/70 px-3 py-2 backdrop-blur dark:border-white/10 dark:bg-slate-950/40">
              ...
              {query ? (
                <button
                  type="button"
                  className="touch-target inline-flex items-center justify-center rounded-lg hover:bg-wood-50 dark:hover:bg-slate-900"
                  aria-label="清除搜索"
                  onClick={() => setQuery('')}
                >
                  <X size={16} />
                  ...
                  {usedParts.length ? (
                    usedParts.map((inst) => {
                      ...
                      return (
                        <div
                          key={inst.instanceId}
                          className="flex items-center justify-between gap-2 rounded-lg px-2 py-1 hover:bg-wood-50 dark:hover:bg-slate-900"
                        >
        ...
        {partDetail ? (
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2 text-sm">
              <div className="rounded-lg bg-wood-50 p-3 dark:bg-slate-900">

  ...
  return (
    <PageContainer className="py-8 space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <button type="button" onClick={() => toast.push('info', '提交参赛即将开放（M6）')} className={`flex items-center gap-3 p-4 text-left transition hover:ring-sky-200 ${CARD}`}>
          <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-[#E8B530]/15 text-[#E8B530]"><Trophy size={18} /></span>
          <div>
            <p className="text-sm font-bold text-sky-900">提交参赛</p>
            <p className="text-xs text-sky-500">把作品投到线上海选 · 即将开放</p>
          </div>
        </button>
      </div>
